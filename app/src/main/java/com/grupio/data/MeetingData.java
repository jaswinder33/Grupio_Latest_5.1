...
public class MeetingData implements Parcelable, Serializable {


    public static final Creator<MeetingData> CREATOR = new Creator<MeetingData>() {

        @Override
        public MeetingData createFromParcel(Parcel source) {
            return new MeetingData(source);
        }
    ...
    public MeetingData(Parcel source) {
